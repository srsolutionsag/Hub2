...
class NewsSettings extends BaseDependentSetting implements IDependentSettings
{
    ...
    protected bool $activate_news = true;
    protected bool $activate_news_block = true;
    protected string $news_block_default_access = self::ACCESS_USERS;
    protected bool $activate_news_block_rss = true;
    protected bool $activate_news_timeline = true;
    protected bool $activate_news_timeline_auto_entries = true;
    protected bool $activate_news_timeline_landing_page = true;
    protected ?\DateTimeImmutable $show_news_after = null;
