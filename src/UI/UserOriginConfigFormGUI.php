...
class UserOriginConfigFormGUI extends OriginConfigFormGUI {
	...
	protected function addPropertiesNew() {
		$activate = new ilCheckboxInputGUI(self::plugin()->translate('usr_prop_activate_account'), $this->prop(UserOriginProperties::ACTIVATE_ACCOUNT));
		...
		$this->addItem($cb);
		$send_password = new ilCheckboxInputGUI(self::plugin()->translate('usr_prop_send_password'), $this->prop(UserOriginProperties::SEND_PASSWORD));
		...
		$subject = new ilTextInputGUI(self::plugin()->translate('usr_prop_password_mail_subject'), $this->prop(UserOriginProperties::PASSWORD_MAIL_SUBJECT));
		$subject->setValue($this->origin->properties()->get(UserOriginProperties::PASSWORD_MAIL_SUBJECT));
		$send_password->addSubItem($subject);
		$mail_body = new ilTextareaInputGUI(self::plugin()->translate('usr_prop_password_mail_body'), $this->prop(UserOriginProperties::PASSWORD_MAIL_BODY));
		...
		$mail_date_format = new ilTextInputGUI(self::plugin()->translate('usr_prop_password_mail_date_format'), $this->prop(UserOriginProperties::PASSWORD_MAIL_DATE_FORMAT));
		$mail_date_format->setInfo('<a target=\'_blank\' href=\'http://php.net/manual/de/function.date.php\'>'
			. htmlspecialchars(self::plugin()->translate('usr_prop_password_mail_date_format_info')) . '</a>');
	...
	protected function addPropertiesUpdate() {
		$activate = new ilCheckboxInputGUI(self::plugin()->translate('usr_prop_reactivate_account'), $this->prop(UserOriginProperties::REACTIVATE_ACCOUNT));
		...
		$activate = new ilCheckboxInputGUI(self::plugin()->translate('usr_prop_resend_password'), $this->prop(UserOriginProperties::RE_SEND_PASSWORD));
