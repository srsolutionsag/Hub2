...
class OrgUnitOriginConfigFormGUI extends OriginConfigFormGUI {
	...
	protected function addSyncConfig() {
		...
		$ref_id_if_no_parent_id = new ilTextInputGUI(self::translate("orgunit_ref_id_if_no_parent_id"), $this->conf(IOrgUnitOriginConfig::REF_ID_IF_NO_PARENT_ID));
		$ref_id_if_no_parent_id->setInfo(self::translate("orgunit_ref_id_if_no_parent_id_info"));
