...
class CourseOriginConfigFormGUI extends OriginConfigFormGUI
{
    ...
    protected function addSyncConfig()
    {
        ...
        $te = new ilTextInputGUI(self::plugin()->translate('crs_prop_node_noparent'),
    ...
    protected function addPropertiesNew()
    {
        ...
        $cb = new ilCheckboxInputGUI(self::plugin()->translate('crs_prop_activate'),
    ...
    protected function addPropertiesUpdate()
    {
        ...
        $cb = new ilCheckboxInputGUI(self::plugin()->translate('crs_prop_move'),
        ...
        $cb = new ilCheckboxInputGUI(self::plugin()->translate('crs_prop_reactivate'),
    ...
    protected function addPropertiesDelete()
    {
        ...
        $opt = new ilRadioOption(self::plugin()->translate('crs_prop_delete_mode_inactive'),
            CourseProperties::DELETE_MODE_OFFLINE);
        $delete->addOption($opt);

        $opt = new ilRadioOption(self::plugin()->translate('crs_prop_delete_mode_delete'),
        ...
        $opt = new ilRadioOption(self::plugin()->translate('crs_prop_delete_mode_trash'),
