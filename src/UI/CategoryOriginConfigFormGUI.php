...
class CategoryOriginConfigFormGUI extends OriginConfigFormGUI {
	...
	protected function addSyncConfig() {
		...
		$te = new ilTextInputGUI(self::translate('cat_prop_base_node_ilias'), $this->conf(ICategoryOriginConfig::REF_ID_NO_PARENT_ID_FOUND));
		$te->setInfo(self::translate('cat_prop_base_node_ilias_info'));
		$te->setValue($this->origin->config()->getParentRefIdIfNoParentIdFound());
		$this->addItem($te);

		$te = new ilTextInputGUI(self::translate('cat_prop_base_node_external'), $this->conf(ICategoryOriginConfig::EXT_ID_NO_PARENT_ID_FOUND));
		$te->setInfo(self::translate('cat_prop_base_node_external_info'));
	...
	protected function addPropertiesNew() {
		...
		$cb = new ilCheckboxInputGUI(self::translate('cat_prop_set_news'), $this->prop(CategoryOriginProperties::SHOW_NEWS));
		$cb->setChecked($this->origin->properties()->get(CategoryOriginProperties::SHOW_NEWS));
		$this->addItem($cb);

		$cb = new ilCheckboxInputGUI(self::translate('cat_prop_set_infopage'), $this->prop(CategoryOriginProperties::SHOW_INFO_TAB));
	...
	protected function addPropertiesUpdate() {
		$cb = new ilCheckboxInputGUI(self::translate('cat_prop_move'), $this->prop(CategoryOriginProperties::MOVE_CATEGORY));
	...
	protected function addPropertiesDelete() {
		$delete = new ilRadioGroupInputGUI(self::translate('cat_prop_delete_mode'), $this->prop(CategoryOriginProperties::DELETE_MODE));
		...
		$opt = new ilRadioOption(self::translate('cat_prop_delete_mode_delete'), CategoryOriginProperties::DELETE_MODE_DELETE);
		$delete->addOption($opt);
